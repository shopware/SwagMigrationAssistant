...
class ProductCmsPageAssociationConverterTest extends ShopwareConverterTest
{
    protected function createConverter(
        ...
        return new ProductCmsPageAssociationConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new ProductCmsPageAssociationDataSet();
    }

    protected static function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/ProductCmsPageAssociation/';
    }
}
