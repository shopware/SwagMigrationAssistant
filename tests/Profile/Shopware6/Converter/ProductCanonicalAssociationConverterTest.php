...
class ProductCanonicalAssociationConverterTest extends ShopwareConverterTest
{
    protected function createConverter(
        ...
        return new ProductCanonicalAssociationConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new ProductCanonicalAssociationDataSet();
    }

    protected static function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/ProductCanonicalAssociation/';
    }
}
