...
class MailHeaderFooterConverterTest extends ShopwareConverterTest
{
    protected function createConverter(
        ...
        return new MailHeaderFooterConverter(
            $mappingService,
            $loggingService,
        );
    }
    ...
    {
        return new MailHeaderFooterDataSet();
    }

    protected static function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/MailHeaderFooter/';
    }
}
