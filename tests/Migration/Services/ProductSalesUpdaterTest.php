...
class ProductSalesUpdaterTest extends TestCase
{
    ...
    public function testUpdatesProductSalesFromPersistedOrderLineItems(): void
    {
        ...
        static::assertEqualsCanonicalizing(
            [$soldProductId, $cancelledProductId],
            $this->productSalesUpdater->getProductIdsForOrders([$openOrderId, $cancelledOrderId, 'invalid', $openOrderId])
        );

        $productIds = [$soldProductId, $cancelledProductId, 'invalid', $soldProductId];
    ...
    public function testUpdateSumsProductSalesAcrossMultipleOrders(): void
    {
        ...
        $secondOrderId = $this->createOrderWithProductLineItem($productId, 2, OrderStates::STATE_OPEN);
    ...
    private function createOrderWithProductLineItem(string $productId, int $quantity, string $state): string
    {
