...
return [
    'orderId' => '32865ab671214a9fbaa215d1b22af44d',
    'fileType' => 'pdf',
    'config' => [
        'displayPrices' => false,
        'logo' => null,
        ...
        'custom' => [
            'deliveryDate' => '2020-12-03T00:00:00+00:00',
            'deliveryNoteDate' => '2020-12-02T11:13:58.636Z',
            'deliveryNoteNumber' => '1000',
        ],
        'extensions' => [
        ],
        'name' => 'delivery_note',
        'global' => true,
        'documentTypeId' => '3292943c32e5499f9a54cc5ff1a16abe',
        'translated' => [
        ],
        'id' => 'be54fb58fe374cd3865a82796350e6d5',
        'diplayLineItemPosition' => true,
        'documentComment' => 'Comment here',
        'documentDate' => '2020-12-02T11:13:58.810Z',
    ],
    'sent' => false,
    'static' => false,
    ...
    'documentMediaFile' => [
        ...
        'url' => 'http://nextsupport.local/api/v3/_action/document/2efbab03c3d84f968bcd5636f9aa4057/NMXl9wyGzE2aB2CAarYHYg2xqtx8XXLN',
        'fileName' => 'delivery_note_10001',
        'mediaFolderId' => 'e49eafe11fbe4396bf1102caeec1f67f',
        'private' => true,
        'id' => '7bcdcfa0af944bb6ab05d2f29811cbb6',
    ],
