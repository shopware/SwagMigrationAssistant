...
module.exports = {
    ...
    moduleNameMapper: {
        ...
        '^src/module/swag-migration/(.*)$': '<rootDir>/src/Resources/app/administration/src/module/swag-migration/$1',
        '^src/core/service/api/swag-migration.api.service$': '<rootDir>/src/Resources/app/administration/src/core/service/api/swag-migration.api.service',
