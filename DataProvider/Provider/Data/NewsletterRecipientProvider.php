...
class NewsletterRecipientProvider extends AbstractProvider
{
     ...
     */
    private $newsletterRecipientRepo;

    public function __construct(EntityRepositoryInterface $newsletterRecipientRepo)
    {
        $this->newsletterRecipientRepo = $newsletterRecipientRepo;
    }
