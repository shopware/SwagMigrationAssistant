...
class Shopware55LocalOrderReader extends Shopware55LocalAbstractReader implements LocalReaderInterface
{
    /**
     * @var array
     */
    ...
    {
        return $profileName === Shopware55Profile::PROFILE_NAME && $dataSet::getEntity() === DefaultEntities::ORDER;
    }
