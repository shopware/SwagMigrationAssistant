...
class Shopware55LocalNewsletterRecipientReader extends Shopware55LocalAbstractReader
{
    public function read(): array
    {
        $ids = $this->fetchIdentifiers('s_campaigns_mailaddresses', $this->migrationContext->getOffset(), $this->migrationContext->getLimit());
