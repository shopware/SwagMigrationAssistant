...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63MailTemplateConverter;
...
class MailTemplateConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63MailTemplateConverter($mappingService, $loggingService, $mediaFileService);
    }
