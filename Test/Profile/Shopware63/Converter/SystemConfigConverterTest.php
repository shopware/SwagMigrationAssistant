...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63SystemConfigConverter;
...
class SystemConfigConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63SystemConfigConverter($mappingService, $loggingService);
    }
