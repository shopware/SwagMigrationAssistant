...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CategoryAssociationConverter;
...
class CategoryAssociationConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CategoryAssociationConverter($mappingService, $loggingService);
    }
