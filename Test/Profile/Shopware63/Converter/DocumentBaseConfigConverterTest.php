...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63DocumentBaseConfigConverter;
...
class DocumentBaseConfigConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63DocumentBaseConfigConverter($mappingService, $loggingService, $mediaFileService);
    }

    protected function createDataSet(): DataSet
    {
        return new DocumentBaseConfigDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/DocumentBaseConfig/';
    }
}
