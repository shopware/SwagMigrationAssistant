...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63MediaFolderConverter;
...
class MediaFolderConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63MediaFolderConverter($mappingService, $loggingService);
    }
