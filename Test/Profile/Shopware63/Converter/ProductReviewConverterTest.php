...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63ProductReviewConverter;
...
class ProductReviewConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63ProductReviewConverter($mappingService, $loggingService);
    }
