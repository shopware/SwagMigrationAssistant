...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CategoryCmsPageAssociationConverter;

class CategoryCmsPageAssociationConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CategoryCmsPageAssociationConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new CategoryCmsPageAssociationDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/CategoryCmsPageAssociation/';
    }
}
