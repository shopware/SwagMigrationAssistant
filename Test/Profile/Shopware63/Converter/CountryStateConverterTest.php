...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CountryStateConverter;
...
class CountryStateConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CountryStateConverter($mappingService, $loggingService);
    }
