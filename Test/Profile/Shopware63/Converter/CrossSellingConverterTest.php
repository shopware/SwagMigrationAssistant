...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CrossSellingConverter;
...
class CrossSellingConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CrossSellingConverter($mappingService, $loggingService);
    }
