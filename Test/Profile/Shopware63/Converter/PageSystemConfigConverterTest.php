...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63PageSystemConfigConverter;
...
class PageSystemConfigConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63PageSystemConfigConverter($mappingService, $loggingService);
    }
