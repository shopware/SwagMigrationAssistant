...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CustomerConverter;

class CustomerConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CustomerConverter($mappingService, $loggingService);
    }
    ...
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/Customer/';
    }
}
