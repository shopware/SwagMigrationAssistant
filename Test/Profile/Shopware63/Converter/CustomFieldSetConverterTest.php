...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CustomFieldSetConverter;

class CustomFieldSetConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CustomFieldSetConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new CustomFieldSetDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/CustomFieldSet/';
    }
}
