...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63DeliveryTimeConverter;
...
class DeliveryTimeConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63DeliveryTimeConverter($mappingService, $loggingService);
    }
