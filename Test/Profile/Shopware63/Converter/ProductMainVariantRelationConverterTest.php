...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63ProductMainVariantRelationConverter;

class ProductMainVariantRelationConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63ProductMainVariantRelationConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new ProductMainVariantRelationDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/ProductMainVariantRelation/';
    }
}
