...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63SalutationConverter;
...
class SalutationConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63SalutationConverter($mappingService, $loggingService);
    }
