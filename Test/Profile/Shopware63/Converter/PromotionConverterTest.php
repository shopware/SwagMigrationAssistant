...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63PromotionConverter;
...
class PromotionConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63PromotionConverter($mappingService, $loggingService);
    }
