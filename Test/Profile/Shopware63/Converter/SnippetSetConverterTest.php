...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63SnippetSetConverter;

class SnippetSetConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63SnippetSetConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new SnippetSetDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/SnippetSet/';
    }
}
