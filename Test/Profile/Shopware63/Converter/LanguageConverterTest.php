...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63LanguageConverter;
...
class LanguageConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63LanguageConverter($mappingService, $loggingService);
    }
