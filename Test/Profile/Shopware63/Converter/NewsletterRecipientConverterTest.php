...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63NewsletterRecipientConverter;
...
class NewsletterRecipientConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63NewsletterRecipientConverter($mappingService, $loggingService);
    }
