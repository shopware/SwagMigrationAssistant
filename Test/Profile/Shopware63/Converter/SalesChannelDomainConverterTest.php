...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63SalesChannelDomainConverter;
...
class SalesChannelDomainConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63SalesChannelDomainConverter($mappingService, $loggingService);
    }
