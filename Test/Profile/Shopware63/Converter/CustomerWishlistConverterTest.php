...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63CustomerWishlistConverter;

class CustomerWishlistConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63CustomerWishlistConverter($mappingService, $loggingService);
    }
    ...
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/CustomerWishlist/';
    }
}
