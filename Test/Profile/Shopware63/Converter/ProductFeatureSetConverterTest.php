...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63ProductFeatureSetConverter;

class ProductFeatureSetConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63ProductFeatureSetConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new ProductFeatureSetDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/ProductFeatureSet/';
    }
}
