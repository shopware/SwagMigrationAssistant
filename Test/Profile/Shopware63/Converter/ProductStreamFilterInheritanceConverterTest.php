...
use SwagMigrationAssistant\Profile\Shopware63\Converter\Shopware63ProductStreamFilterInheritanceConverter;

class ProductStreamFilterInheritanceConverterTest extends ShopwareConverterTest
{
    ...
    {
        return new Shopware63ProductStreamFilterInheritanceConverter($mappingService, $loggingService);
    }

    protected function createDataSet(): DataSet
    {
        return new ProductStreamFilterInheritanceDataSet();
    }

    protected function getFixtureBasePath(): string
    {
        return __DIR__ . '/../../../_fixtures/Shopware6/ProductStreamFilterInheritance/';
    }
}
