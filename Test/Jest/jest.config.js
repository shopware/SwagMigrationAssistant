...
module.exports = {
    preset: './Test/Jest/node_modules/@shopware-ag/jest-preset-sw6-admin/jest-preset.js',
    globals: {
    ...
    moduleDirectories: [
        '<rootDir>/Test/Jest/node_modules',
    ...
    collectCoverageFrom: [
        '<rootDir>/Resources/app/administration/src/**/*.js',
        '<rootDir>/Resources/app/administration/src/**/*.ts',
    ],
    ...
    moduleNameMapper: {
        ...
        '^SwagMigrationAssistant/(.*)$': '<rootDir>/Resources/app/administration/src/$1',
    },
