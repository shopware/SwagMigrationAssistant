...
readonly class ConvertShippingCalculationTypeUnsupportedLog extends AbstractMigrationLogEntry
{
    ...
    {
        return 'SWAG_MIGRATION_CONVERT_SHIPPING_CALCULATION_TYPE_UNSUPPORTED';
    }
}
